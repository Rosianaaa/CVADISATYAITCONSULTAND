...
<section class="banner-area other-page">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1>Kontak Kami</h1>
                <a href="/beranda">Beranda</a> <span>|</span> <a href="/kontak">Kontak</a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5 mb-lg-0">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="info-text">
                            <h3>+62 831 1152 7851</h3>
                            <p>Sen - Jum 9am - 6 pm</p>
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="into-icon">
                ...
                <div class="col-lg-9">
                    <form action="#">
                        <div class="left">
                            <input type="text" placeholder="Ketik Nama" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ketik Nama'" required>
                            <input type="email" placeholder="Alamat Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Alamat Email'" required>
                            <input type="text" placeholder="Subjek" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Subjek'" required>
                        </div>
                        <div class="right">
                            <textarea name="message" cols="20" rows="7"  placeholder="Ketik Pesan" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ketik Pesan'" required></textarea>
                        </div>
...
<?php /**PATH C:\Users\LENOVO SLIM 1\Documents\applications\meblood\resources\views/kontak.blade.php ENDPATH**/ ?>